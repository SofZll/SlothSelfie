...
const { createActivity, getActivities, getActivity, updateActivity, deleteActivity, createInputAsNote, createOutputAsNote, updateActivityStatus } = require('../controllers/activityController');
