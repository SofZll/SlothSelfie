...
const { createActivity, getActivities, updateActivity, deleteActivity, exportActivity, createNoteAsInputOrOutput, updateOutputAsNote, updateActivityStatus, adjustOrContractActivitySchedule } = require('../controllers/activityController');
