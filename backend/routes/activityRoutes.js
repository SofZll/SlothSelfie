...
const { createActivity, getActivities, getActivity, updateActivity, deleteActivity, createInputAsNote, createOutputAsNote, updateOutputAsNote, updateActivityStatus, adjustOrContractActivitySchedule } = require('../controllers/activityController');
